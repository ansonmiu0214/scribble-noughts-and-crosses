...
export default class P1 extends React.Component<P, S> {
  ...
  componentDidMount() {
    ...
    this.state.ws.addEventListener('open', () => this.state.ws.send(Message.connect(Roles.P1)))
  }
  ...
  private _onReceiveInit(ev: MessageEvent) {
    ...
    this.setState({ efsm: [StateId.S31, <Elem Pos={this._buildSendElement<Point>('Pos').bind(this)}/>] })
  }
